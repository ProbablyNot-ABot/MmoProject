...
public class Login : MonoBehaviour {
	...
	void Start () {
		...
		SkillBridge.Message.FirstTestRequest testRequest = new SkillBridge.Message.FirstTestRequest();
		testRequest.Helloworld = "Hello World";

		//msg.Request.firstRequest = testRequest;
