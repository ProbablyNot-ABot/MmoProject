...
namespace Services
{
    ...
    {
        public delegate bool StatusNotifyHander(NStatus status);

        Dictionary<StatusType, StatusNotifyHander> eventMap = new Dictionary<StatusType, StatusNotifyHander>();
        HashSet<StatusNotifyHander> handles = new HashSet<StatusNotifyHander>();
        public void Init()
        {

        }

        public void RegisterStatusNotify(StatusType function, StatusNotifyHander action)
        {
